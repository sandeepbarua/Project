<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassWord.aspx.cs" Inherits="PresentationLayer.ForgotPassWord" %>
...
<head runat="server">
<meta charset="UTF-8">
<title>DQF::Forgot Password</title>
...
<div class="login_wrapper">
  ...
  <asp:TextBox ID="txtAgentID" runat="server" placeholder="Username" class="form-control" maxlength="80" size="30" ValidationGroup="forgotpass" ></asp:TextBox>
            ...
            <asp:RegularExpressionValidator ID="revEmail" runat="server"
                                            ...
                                            ErrorMessage="Input valid email address!" ForeColor="White" ValidationGroup="forgotpass" EnableClientScript="true"
        ...
        <div class="row">
            <div class="col col-12 text-right">
        	 <asp:Button ID="btnForgotPassword" ValidationGroup="forgotpass" class="mq-btn btn btn-primary nxt_btn" runat="server" Text="Forgot Password" OnClick="btnForgotPassword_Click" />
          
        	 <asp:Button ID="btnlogin" class="mq-btn btn btn-primary nxt_btn" runat="server" Text="Login" OnClick="btnlogin_Click" />
           </div>
            </div>
...
<script src="vendor/bootstrap/js/bootstrap-select.min.js"></script>
 <script type="text/javascript">
         function validateemail() {
             var Email = document.getElementById('<%=txtAgentID.ClientID %>').value;
