<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Passwordreset.aspx.cs" Inherits="PresentationLayer.Passwordreset" %>
...
<div class="login_wrapper">
  ...
  <asp:TextBox ID="txtAgentID" runat="server" placeholder="Enter New Password" TextMode="Password" class="form-control" maxlength="80" size="30" ValidationGroup="forgotpass" ></asp:TextBox>
        ...
        <div class="form-group has-feedback">
              <asp:TextBox ID="txtPassword" runat="server" class="form-control" TextMode="Password"  placeholder="Confirm New Password" maxlength="80" size="30" ValidationGroup="forgotpass" ></asp:TextBox>
                           <asp:RequiredFieldValidator
             ID="RequiredFieldValidator2"
             runat="server"
             ControlToValidate="txtPassword"
             ErrorMessage='Enter Confirm New Password'
                               ValidationGroup="forgotpass"
	...
	ControlToCompare="txtAgentID" ControlToValidate="txtPassword" ValidationGroup="forgotpass" ForeColor="White" 
	ErrorMessage="Password does not match."></asp:CompareValidator>
          <span class="fa fa-user form-control-feedback"></span> <span><font color="red"></font></span> </div>
          
          <div><asp:Label ID="lblMessage" runat="server" CssClass="require" /></div>
        <div class="row">
            <div class="col col-12 text-right">
        	 <asp:Button ID="btnLogin" OnClientClick="RemoveErrorMessage();" ValidationGroup="forgotpass" class="mq-btn btn btn-primary nxt_btn" runat="server" Text="Reset" OnClick="btnLogin_Click"/>
          <asp:Button ID="btnloginfordefault" class="mq-btn btn btn-primary nxt_btn" runat="server" Text="Login" OnClick="btnloginfordefault_Click" />
                 </div>
            </div>
