<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UsrCurrentResidenceDetail.ascx.cs" Inherits="PresentationLayer.UserControls.UsrCurrentResidenceDetail" %>
