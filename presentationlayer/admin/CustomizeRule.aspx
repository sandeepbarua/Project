<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin2.Master" AutoEventWireup="true" CodeBehind="CustomizeRule.aspx.cs" Inherits="PresentationLayer.Admin_New.CustomizeRule" %>
    ...
    <asp:Panel ID="pnlMainBody" runat="server">
        ...
        <div class="main-panel">
                ...
                <div class="modal-header bg-aqua-active">
                    <h4 class="modal-title">CUSTOMIZE AUDIT RULE</h4>
                </div>
        ...
        <table id="Table1" style="margin-bottom: 2px" class="table  table-bordered table-striped display">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="col" style="width: 40%; text-align: center">Audit Question</th>
       <%--                 <th class="col" style="width:  60px; text-align: center">Template</th>--%>
                        ...
                        <th class="col" style="width: 45%; text-align: center">Rules</th>
                                    ...
                                    <asp:Repeater ID="Reptrule" runat="server">
                                            ...
                                            <table class="table  table-bordered table-striped display">
                                                <thead>
                                                    <tr style="background-color: #D6D6D6">
                                                        <th class="col" style="width: 40%; color: dimgray; text-align: center">Variable</th>
                                                        <th class="col" style="width: 45%; color: dimgray; text-align: center">Rule</th>
                                                        <th class="col" style="width: 15%; color: dimgray; text-align: center"></th>
                                                    </tr>
                                        </HeaderTemplate>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                 <asp:LinkButton ID="OnDelete" runat="server" class="btn  btn-outline-danger" ToolTip="Delete"  OnClientClick = "return confirm('Do you want to Delete data?')"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                </td>
                                            </tr>
