...
{
    public partial class CustomizeRule : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["DocumentId"] !=null)
                {
                    ...
                    BindgridView(Convert.ToInt32(CustomerID.Value), Convert.ToInt32(ddlDocumentType.SelectedValue));                    
                }
        ...
        protected void OnDelete_Click(object sender, EventArgs e)
        {
            ...
            Doc.CustomerID = Convert.ToInt32(CustomerID.Value);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            Doc1.CustomerID = Convert.ToInt32(CustomerID.Value);// Convert.ToInt32(ddlCustomer.SelectedValue);
        ...
        protected void BtnCreateuser_Click(object sender, EventArgs e)
        {
            ...
            MlAuditQuestion Doc1 = new MlAuditQuestion();
            Doc1.CustomerID = Convert.ToInt32(CustomerID.Value);
            Doc1.DocumentID = Convert.ToInt32(ddlDocumentType.SelectedValue);
            BindgridView(Doc1.CustomerID, Doc1.DocumentID);
        }
        ...
        protected void BtnSubmitExpression_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ObjBLConsumeApi.SpInsertAuditRuleClassification(Convert.ToInt32(CustomerID.Value), DocTypeId, AuditQuention, DynamicControlId, RuleExpression, RuleType, DynamicControlLabel, UserId);
                MlAuditQuestion Doc = new MlAuditQuestion();
                Doc.CustomerID = Convert.ToInt32(CustomerID.Value);
                Doc.DocumentID = Convert.ToInt32(ddlDocumentType.SelectedValue);
