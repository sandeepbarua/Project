<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="DynamicControl.aspx.cs" Inherits="PresentationLayer.Admin.DynamicControl" %>
                        ...
                        <div class="row">
                            <table  width="75%">
                                    <tr>
                                        ...
                                        <td width="50%"><asp:DropDownList ID="ddlCustomer"  class="form-control" runat="server" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="ddlCustomer_SelectedIndexChanged"></asp:DropDownList></td>
                ...
                <div class="template">
                   ...
                   <%--                     <td id="CustomerID" style="width: 100px" class="classControlName"><%# DataBinder.Eval(Container.DataItem, "ControlName")%></td>--%>
                                        ...
                                        <td class="classControlTypeID" style="display:none"><%# DataBinder.Eval(Container.DataItem, "ControlTypeID")%></td>
                                         <td style="width: 150px"><asp:TextBox ID="txtOrderNo" runat="server" onkeypress="CheckNumeric(event);" Width="40px" Text='<%#Eval("OrderBy") %>'></asp:TextBox></td>
