...
{
    public partial class TemplateDynamicControl : System.Web.UI.Page
    {
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("EditControl.aspx?DynamicId=" + hd.Value + "&Label=" + hd1.Value+ "&drop="+ hd2.Value+"&docName="+ ddlDocumentType.SelectedItem.ToString()+"&Id="+ ddlDocumentType.SelectedValue, false);
        }
